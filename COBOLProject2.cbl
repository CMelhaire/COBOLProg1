      ...
      ******************************************************************
       ...
       FILE-CONTROL.
		   ...
		   SELECT SortedInFile ASSIGN TO "SORTED.DAT"
		  ORGANIZATION IS LINE SEQUENTIAL.
	   ...
	   FD SortedInFile.
	   01 SALES-FILE-ID-s.
           05 CUST-NO-s            PIC 9(4).
		   05                      PIC X VALUE SPACES.
           05 CUST-NAME-s          PIC A(20).
		   05                      PIC X VALUE SPACES.
           05 UNIT-PRICE-s         PIC 9(5).
		   05                      PIC X VALUE SPACES.
           05 QUANTITY-SOLD-s      PIC -9(3).

	   SD workfile.
	    01 SALES-FILE-ID-w.
           05 CUST-NO-w            PIC 9(4).
		   05                      PIC X VALUE SPACES.
           05 CUST-NAME-w          PIC A(20).
		   05                      PIC X VALUE SPACES.
           05 UNIT-PRICE-w         PIC 9(5).
		   05                      PIC X VALUE SPACES.
           05 QUANTITY-SOLD-w      PIC -9(3).
...
************************************************************************
	* *   000-SORT-MODULE
*      This sorts the file by the customer numbe 
*     ******************************************************************
*      000-SORT-MODULE.
		   SORT WorkFile on ASCENDING CUST-NO-w
		   using SALES-FILE giving SortedInFile.
		   exit.
